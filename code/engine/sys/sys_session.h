...
// voiceStateDisplay_t
//------------------------
enum voiceStateDisplay_t { VOICECHAT_DISPLAY_NONE, VOICECHAT_DISPLAY_NOTTALKING, VOICECHAT_DISPLAY_TALKING, VOICECHAT_DISPLAY_TALKING_GLOBAL, VOICECHAT_DISPLAY_MUTED, VOICECHAT_DISPLAY_MAX };
...
{
public:
	enum sessionState_t { IDLE, SEARCHING, CONNECTING, PARTY_LOBBY, GAME_LOBBY, LOADING, INGAME, BUSY, MAX_STATES };
