...
typedef enum { AUTORENDER_DEFAULTICON = 0, AUTORENDER_HELLICON, AUTORENDER_DIALOGICON, AUTORENDER_MAX } autoRenderIconType_t;
...
enum graphicsGpuType_t { GPU_TYPE_DISCRETE, GPU_TYPE_OTHER };
...
public:
	...
	*/
	...
	virtual const emptyCommand_t* SwapCommandBuffers(
		uint64* frontEndMicroSec, uint64* backEndMicroSec, uint64* shadowMicroSec, uint64* gpuMicroSec, backEndCounters_t* bc, performanceCounters_t* pc ) = 0;
