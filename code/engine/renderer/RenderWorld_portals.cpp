...
bool idRenderWorldLocal::PortalIsFoggedOut( const portal_t* p )
{
	...
	lightShader->EvaluateRegisters( regs, ldef->parms.shaderParms, tr.viewDef->renderView.shaderParms, tr.viewDef->renderView.time[0] * 0.001f, ldef->parms.referenceSound );
