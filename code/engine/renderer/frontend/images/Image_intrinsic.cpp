...
#include "../tr_local.h"
#include "baked/SMAA_AreaTex.h"
#include "baked/SMAA_SearchTex.h"
#include "baked/Image_brdfLut.h"
// #include "Image_blueNoiseVC_1M.h" // 256^2 R8 data
#include "baked/Image_blueNoiseVC_2.h" // 512^2 RGB8 data

#include "baked/Image_env_UAC_lobby_amb.h"
#include "baked/Image_env_UAC_lobby_spec.h"
...
void idImage::MakeDefault( nvrhi::ICommandList* commandList )
{
	...
	GenerateImage( ( byte* )data, DEFAULT_SIZE, DEFAULT_SIZE, TF_DEFAULT, TR_REPEAT, TD_DEFAULT, commandList );
...
static void R_CreateEnvprobeImage_UAC_lobby_irradiance( idImage* image, nvrhi::ICommandList* commandList )
{
	image->GenerateImage( ( byte* )IMAGE_ENV_UAC_LOBBY_AMB_H_Bytes,
		IMAGE_ENV_UAC_LOBBY_AMB_H_TEX_WIDTH,
		IMAGE_ENV_UAC_LOBBY_AMB_H_TEX_HEIGHT,
		TF_LINEAR,
		TR_CLAMP,
		TD_HDR_LIGHTPROBE,
		commandList,
...
static void R_CreateEnvprobeImage_UAC_lobby_radiance( idImage* image, nvrhi::ICommandList* commandList )
{
	image->GenerateImage( ( byte* )IMAGE_ENV_UAC_LOBBY_SPEC_H_Bytes,
		...
		IMAGE_ENV_UAC_LOBBY_SPEC_H_TEX_HEIGHT,
		TF_DEFAULT,
		TR_CLAMP,
		TD_HDR_LIGHTPROBE,
		commandList,
