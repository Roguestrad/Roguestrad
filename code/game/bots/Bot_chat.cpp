...
const char* bot_kill_insult[] = {
	"%s: Try aiming next time %s", "%s: Trust me when I say this %s, you suck.", "%s: Maybe you should go back to go cart racing %s?", "%s: Your technique reminds me of a story %s, a very dull one."
};

const char* bot_death_insult[] = { "%s: Mmmmmmm. Was it good for you too %s?",
...
const char* bot_death_praise[] = { "%s: %s not bad for an amateur.",
