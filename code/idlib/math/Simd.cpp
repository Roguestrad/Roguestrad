...
//! Calculates and sets the base clock value by running multiple timing tests and selecting the best result.
void GetBaseClocks()
{
...
//! Tests the MinMax function implementation for various data types and compares generic and SIMD performance.
void TestMinMax()
{
	int		  i;
...
//! Tests and compares the performance of generic and SIMD memcpy implementations.
void TestMemcpy()
{
	TIME_TYPE	start, end, bestClocksGeneric, bestClocksSIMD;
	int			i;
...
//! Tests the blending of joint transformations using generic and SIMD implementations
...
//! Tests the performance of the BlendJointsFast function implementation
...
//! Tests the conversion from joint matrices to joint quaternions.
...
//! Tests the joint transformation functionality using both generic and SIMD implementations.
...
//! Tests the UntransformJoints function with random joint data to compare generic and SIMD implementations
...
//! Tests various math functions and compares their performance
void TestMath()
{
	int		  i;
