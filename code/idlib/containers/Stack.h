...
/*!
	...
	\brief A templated stack implementation that manages elements in a last-in-first-out manner.
*/
template<class type, int nextOffset>
class idStackTemplate
{
public:
	//! Constructs an empty stack template instance.
	idStackTemplate();

	//! Adds an element to the top of the stack
	void  Add( type* element );

	//! Retrieves and removes the top element from the stack template.
	type* Get();
