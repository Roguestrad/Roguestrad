...
/*!
	\class idSort
	\brief Abstract template class for sorting arrays of objects.
*/
template<typename _type_>
class idSort
{
...
/*!
	\class idSort_Quick
	\brief A template class implementing a hybrid quicksort and insertion sort algorithm for sorting arrays of elements.
*/
template<typename _type_, typename _derived_>
class idSort_Quick : public idSort<_type_>
{
public:
	//! Sorts an array of elements using a hybrid quicksort and insertion sort algorithm.
...
/*!
	...
	\brief A quick-sort implementation for sorting scalar values in ascending order.
*/
template<typename _type_>
class idSort_QuickDefault : public idSort_Quick<_type_, idSort_QuickDefault<_type_>>
{
public:
	//! Compares two values and returns their difference
	int Compare( const _type_& a, const _type_& b ) const { return a - b; }
};

/*!
	\class idSort_QuickDefault< float >
	\brief A specialization of quick sort for floating point values that avoids float-to-int conversion during comparisons.
*/
template<>
class idSort_QuickDefault<float> : public idSort_Quick<float, idSort_QuickDefault<float>>
{
public:
	//! Compares two float values and returns an integer less than, equal to, or greater than zero if the first value is found to be less than, equal to, or greater than the second value respectively.
...
/*!
	\class idSort_Heap
	\brief A template class implementing the heap sort algorithm for sorting arrays of elements.
*/
template<typename _type_, typename _derived_>
class idSort_Heap : public idSort<_type_>
{
public:
	//! Sorts an array of elements using the heap sort algorithm.
	virtual void Sort( _type_* base, unsigned int num ) const
	{
...
/*!
	...
	\brief Default heap-sort comparison function for sorting scalars in ascending order.
*/
template<typename _type_>
...
/*!
	...
	\brief A template class that implements the insertion sort algorithm for sorting arrays of elements.
*/
template<typename _type_, typename _derived_>
...
/*!
	...
	\brief A default insertion sort comparison function for sorting scalars in ascending order.
*/
template<typename _type_>
