...
idCVar  idFileSystemLocal::fs_game_base( "fs_game_base", "mod_vr", CVAR_SYSTEM | CVAR_INIT | CVAR_SERVERINFO, "alternate mod path, searched after the main fs_game path, before the basedir" );
